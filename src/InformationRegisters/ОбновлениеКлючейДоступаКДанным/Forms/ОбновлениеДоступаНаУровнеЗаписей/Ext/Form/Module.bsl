...
Процедура ЗапуститьРегламентноеЗаданиеСейчас(Команда)
	...
	ТекстПредупреждения = ЗапуститьРегламентноеЗаданиеСейчасНаСервере(СостояниеЗаданияОбновленияДоступа);
...
&НаСервереБезКонтекста
Функция ЗапуститьРегламентноеЗаданиеСейчасНаСервере(СостояниеЗаданияОбновленияДоступа)
