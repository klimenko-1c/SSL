...
Процедура ПрочитатьДанныеВЖурналРегистрации(РезультатОбновления, КаталогСкрипта)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПрочитатьДанныеВЖурналРегистрацииПриОбработкеФайловЛога", ЭтотОбъект);
	НачатьПоискФайлов(ОписаниеОповещения, КаталогСкрипта, "log*.txt");
	
КонецПроцедуры

Процедура ПрочитатьДанныеВЖурналРегистрацииПриОбработкеФайловЛога(НайденныеФайлы, Контекст) Экспорт
	
	Если НайденныеФайлы.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;
	
	ФайлЖурнала = НайденныеФайлы[0];
