...
Функция ЗначенияЭлементовНастроек(Настройки, ПользовательскиеНастройки, Поле)
	...
	НайтиЗначенияПоляЭлементовОтбора(Поле, Настройки.Отбор.Элементы, ПользовательскиеНастройки, Значения);
	
	Возврат Значения;
КонецФункции

Процедура НайтиЗначенияПоляЭлементовОтбора(Поле, ЭлементыОтбора, ПользовательскиеНастройки, Значения)
	Для Каждого Элемент Из ЭлементыОтбора Цикл 
		...
		Если ТипЗнч(ЭлементАнализируемый) = Тип("ГруппаЭлементовОтбораКомпоновкиДанных") Тогда 
			НайтиЗначенияПоляЭлементовОтбора(Поле, Элемент.Элементы, ПользовательскиеНастройки, Значения);
		Иначе
