...
//                       будет определен автоматически. Список кодировок см. в синтаксис-помощнике в 
...
//         если не указан ДождатьсяЗавершения - игнорируется.
//    * КодировкаИсполнения - Строка - Кодировка, устанавливаемая в Windows с помощью команды chcp.
//          в Linux и MacOS игнорируется. Возможные значения "OEM" и "UTF8".
...
#Иначе
	...
	Пока ПозицияРасширения > 0 Цикл
		...
		ИмяФайла = Сред(ИмяФайла, ПозицияРасширения + 1);
		ПозицияРасширения = СтрНайти(ИмяФайла, ".");
