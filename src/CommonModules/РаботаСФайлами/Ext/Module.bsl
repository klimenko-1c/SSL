...
//
// Возвращаемое значение:
//  Структура, Неопределено - Структура, содержащая информацию о присоединенном файле. Если файл не найден или
...
//    * Служебный                          - Булево - Признак, что файл является служебным.
//
...
//  ДобавляемыеЭлементы - Структура, Массив - структура параметров элементов управления
...
//                                или элемент не найден, поле будет добавлена на форму после всех существующих
...
//                                Формат см. в свойстве Фильтр объекта ДиалогВыбораФайла в синтаксис-помощнике.
...
Функция СоздатьФайлНаОсновеФайлаНаДиске(ВладелецФайлов, ПутьКФайлуНаДиске) Экспорт
	...
	Возврат РаботаСФайлами.ДобавитьФайлСДиска(ВладелецФайлов, ПутьКФайлуНаДиске);
