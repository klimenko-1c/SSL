...
Процедура ОбновитьСвойстваНастройки(Форма, КомпоновщикНастроек, ЭлементПользовательскойНастройки) Экспорт 
	Свойства = "Использование";
	Если ТипЗнч(ЭлементПользовательскойНастройки) = Тип("ЗначениеПараметраНастроекКомпоновкиДанных") Тогда 
		Свойства = Свойства + ", Значение";
	ИначеЕсли ТипЗнч(ЭлементПользовательскойНастройки) = Тип("ЭлементОтбораКомпоновкиДанных") Тогда 
		Свойства = Свойства + ", ВидСравнения, ПравоеЗначение";
	КонецЕсли;
	...
	Если ЭлементНастройки <> Неопределено Тогда 
		ЗаполнитьЗначенияСвойств(ЭлементНастройки, ЭлементПользовательскойНастройки, Свойства);
	КонецЕсли;
	
	// Завершение синхронизации:
	// * В пользовательских настройках, в зависимости от типа, не заполнены свойства:
	//   ** ЛевоеЗначение, Представление, Отбор, Оформление, Поля, РежимОтображения.
	ЗаполнитьЗначенияСвойств(ЭлементПользовательскойНастройки, ЭлементНастройки);
