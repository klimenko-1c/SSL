...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользуетсяПочтовыйКлиент = ИспользуетсяПочтовыйКлиент();
	Элементы.ОтправлятьСкрытыеКопииПисемНаЭтотАдрес.Видимость = ИспользуетсяПротоколPOP Или Не ИспользуетсяПочтовыйКлиент;
...
Функция ИспользуетсяПочтовыйКлиент()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.Взаимодействия") Тогда
		...
		Результат = МодульВзаимодействия.ИспользуетсяПочтовыйКлиент();
	КонецЕсли;
