	...
	Для Каждого ОбновляемыйНабор Из Результат Цикл
		...
		Попытка
			...
			Если ОбновляемыйНабор.ЭтоГруппа <> НовыйНаборОбъект.ЭтоГруппа Тогда
				...
				Продолжить;
			КонецЕсли;
			НовыйНаборОбъект.ДополнительныеРеквизиты.Загрузить(ОбновляемыйНабор.ДополнительныеРеквизиты);
			НовыйНаборОбъект.ДополнительныеСведения.Загрузить(ОбновляемыйНабор.ДополнительныеСведения);
