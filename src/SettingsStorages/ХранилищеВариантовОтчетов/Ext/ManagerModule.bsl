...
Функция КлючиВариантовОтчета(КлючОтчета, Знач Пользователь = Неопределено) Экспорт
	КлючиВариантовОтчета = Новый СписокЗначений;
...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	...
	Для Каждого СтрокаТаблицы Из ТаблицаВариантов Цикл
		КлючиВариантовОтчета.Добавить(СтрокаТаблицы.КлючВарианта, СтрокаТаблицы.Наименование);
	КонецЦикла;
#КонецЕсли
